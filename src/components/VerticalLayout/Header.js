                ...
                <header id="page-topbar">
                  ...
                  <span className="logo-sm">
                    ...
                    <img src={logoLightPng} alt="" height="19"/>
                            ...
                            <Dropdown className="dropdown-mega d-none d-lg-block ml-2" isOpen={this.state.megaMenuDrp}
                                      toggle={() => {
                                          this.setState({megaMenuDrp: !this.state.megaMenuDrp})
                                      }}>
                                <DropdownToggle className="btn header-item waves-effect" caret tag="button"> Mega
                                    Menu {" "}
                        ...
                        <div className="d-flex">
                            <div className="dropdown d-inline-block d-lg-none ml-2">
                                ...
                                }} type="button" className="btn header-item noti-icon waves-effect"
                            ...
                            <Dropdown className="d-none d-lg-inline-block ml-1" isOpen={this.state.socialDrp}
                                      toggle={() => {
                            ...
                            <div className="dropdown d-none d-lg-inline-block ml-1">
                                <button type="button" onClick={this.toggleFullscreen}
                                        className="btn header-item noti-icon waves-effect" data-toggle="fullscreen">
