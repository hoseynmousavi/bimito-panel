                                ...
                                <ul className="navbar-nav">
                                    ...
                                    <li className="nav-item dropdown">
                                        <Link to="/#" onClick={e => {
                                            ...
                                            <i className="bx bx-tone mr-2"></i>UI Elements <div
                                            ...
                                            <Row>
                                                <Col lg={4}>
                                                    <div>
                                                        ...
                                                        <Link to="ui-dropdowns"
                                                              className="dropdown-item">Dropdowns</Link>
                                                ...
                                                <Col lg={4}>
                                                    <div>
                                                        ...
                                                        <Link to="ui-rangeslider" className="dropdown-item">Range
                                                            Slider</Link>
                                                        <Link to="ui-session-timeout" className="dropdown-item">Session
                                                            Timeout</Link>
                                                        <Link to="ui-progressbars" className="dropdown-item">Progress
                                                            Bars</Link>
                                                        <Link to="ui-sweet-alert"
                                                              className="dropdown-item">Sweet-Alert</Link>
                                                    </div>
                                                </Col>
                                                <Col lg={4}>
                                                    <div>
                                                        <Link to="ui-tabs-accordions" className="dropdown-item">Tabs &
                                                            Accordions</Link>
                                                        <Link to="ui-typography"
                                                              className="dropdown-item">Typography</Link>
                                    ...
                                    <li className="nav-item dropdown">
                                        <Link to="/#" onClick={e => {
                                            ...
                                            <i className="bx bx-customize mr-2"></i>Apps <div
                                            className="arrow-down"></div>
                                        </Link>
                                        <div className={classname("dropdown-menu", {show: this.state.appState})}>
                                            ...
                                            <div className="dropdown">
                                                ...
                                                <div
                                                    className={classname("dropdown-menu", {show: this.state.emailState})}>
                                            ...
                                            <div className="dropdown">
                                                ...
                                                <div
                                                    className={classname("dropdown-menu", {show: this.state.ecommerceState})}>
                                                    <Link to="ecommerce-products"
                                                          className="dropdown-item">Products</Link>
                                                    <Link to="ecommerce-product-detail" className="dropdown-item">Product
                                                        Detail</Link>
                                                    <Link to="ecommerce-orders" className="dropdown-item">Orders</Link>
                                                    <Link to="ecommerce-customers"
                                                          className="dropdown-item">Customers</Link>
                                                    <Link to="ecommerce-cart" className="dropdown-item">Cart</Link>
                                                    <Link to="ecommerce-checkout"
                                                          className="dropdown-item">Checkout</Link>
                                                    <Link to="ecommerce-shops" className="dropdown-item">Shops</Link>
                                                    <Link to="ecommerce-add-product" className="dropdown-item">Add
                                                        Product</Link>
                                                </div>
                                            </div>
                                            ...
                                            <div className="dropdown">
                                                ...
                                                <div
                                                    className={classname("dropdown-menu", {show: this.state.projectState})}>
                                                    <Link to="projects-grid" className="dropdown-item">Projects
                                                        Grid</Link>
                                                    <Link to="projects-list" className="dropdown-item">Projects
                                                        List</Link>
                                                    <Link to="projects-overview" className="dropdown-item">Project
                                                        Overview</Link>
                                                    <Link to="projects-create" className="dropdown-item">Create
                                                        New</Link>
                                                </div>
                                            </div>
                                            <div className="dropdown">
                                                ...
                                                <div
                                                    className={classname("dropdown-menu", {show: this.state.taskState})}>
                                                    <Link to="tasks-list" className="dropdown-item">Task List</Link>
                                                    <Link to="tasks-kanban" className="dropdown-item">Kanban
                                                        Board</Link>
                                            ...
                                            <div className="dropdown">
                                                ...
                                                <div
                                                    className={classname("dropdown-menu", {show: this.state.contactState})}>
                                    ...
                                    <li className="nav-item dropdown">
                                        <Link to="/#" className="nav-link dropdown-toggle arrow-none"
                                            ...
                                            <i className="bx bx-collection mr-2"></i>Components <div
                                            className="arrow-down"></div>
                                        </Link>
                                        <div className={classname("dropdown-menu", {show: this.state.componentState})}>
                                            <div className="dropdown">
                                                ...
                                                <div
                                                    className={classname("dropdown-menu", {show: this.state.formState})}>
                                                    <Link to="form-elements" className="dropdown-item">Form
                                                        Elements</Link>
                                                    <Link to="form-validation" className="dropdown-item">Form
                                                        Validation</Link>
                                                    <Link to="form-advanced" className="dropdown-item">Form
                                                        Advanced</Link>
                                                    <Link to="form-editors" className="dropdown-item">Form
                                                        Editors</Link>
                                                    <Link to="form-uploads" className="dropdown-item">Form File
                                                        Upload</Link>
                                                    <Link to="form-xeditable" className="dropdown-item">Form
                                                        Xeditable</Link>
                                                    <Link to="form-repeater" className="dropdown-item">Form
                                                        Repeater</Link>
                                            ...
                                            <div className="dropdown">
                                                ...
                                                <div
                                                    className={classname("dropdown-menu", {show: this.state.tableState})}>
                                                    <Link to="tables-basic" className="dropdown-item">Basic
                                                        Tables</Link>
                                                    <Link to="tables-datatable" className="dropdown-item">Data
                                                        Tables</Link>
                                                    <Link to="tables-responsive" className="dropdown-item">Responsive
                                                        Table</Link>
                                                    <Link to="tables-editable" className="dropdown-item">Editable
                                                        Table</Link>
                                                </div>
                                            </div>
                                            <div className="dropdown">
                                                ...
                                                <div
                                                    className={classname("dropdown-menu", {show: this.state.chartState})}>


                                                    <Link to="apex-charts" className="dropdown-item">Apex charts</Link>
                                                    <Link to="chartist-charts" className="dropdown-item">Chartjs
                                                        Chart</Link>
                                                    <Link to="e-charts" className="dropdown-item">E Chart</Link>
                                                    <Link to="tui-charts" className="dropdown-item">Toast UI
                                                        Chart</Link>
                                                    <Link to="sparkline-charts" className="dropdown-item">Sparkline
                                                        Chart</Link>
                                                </div>
                                            </div>
                                            <div className="dropdown">
                                                ...
                                                <div
                                                    className={classname("dropdown-menu", {show: this.state.iconState})}>
                                                    <Link to="icons-boxicons" className="dropdown-item">Boxicons</Link>
                                                    <Link to="icons-materialdesign" className="dropdown-item">Material
                                                        Design</Link>
                                                    <Link to="icons-dripicons"
                                                          className="dropdown-item">Dripicons</Link>
                                                    <Link to="icons-fontawesome" className="dropdown-item">Font
                                                        awesome</Link>
                                                </div>
                                            </div>
                                            <div className="dropdown">
                                                ...
                                                <div
                                                    className={classname("dropdown-menu", {show: this.state.mapState})}>
                                    ...
                                    <li className="nav-item dropdown">
                                        <Link className="nav-link dropdown-toggle arrow-none" to="#"
                                            ...
                                            <i className="bx bx-file mr-2"></i>Extra pages <div
                                            className="arrow-down"></div>
                                        </Link>
                                        <div className={classname("dropdown-menu", {show: this.state.extraState})}>
                                            <div className="dropdown">
                                                ...
                                                <div
                                                    className={classname("dropdown-menu", {show: this.state.invoiceState})}>
                                                    <Link to="invoices-list" className="dropdown-item">Invoice
                                                        List</Link>
                                                    <Link to="invoices-detail" className="dropdown-item">Invoice
                                                        Detail</Link>
                                                </div>
                                            </div>
                                            ...
                                            <div className="dropdown">
                                                ...
                                                <div
                                                    className={classname("dropdown-menu", {show: this.state.authState})}>
                                                    <Link to="pages-login" className="dropdown-item">Login</Link>
                                                    <Link to="pages-register" className="dropdown-item">Register</Link>
                                                    <Link to="pages-forget-pwd" className="dropdown-item">Forget
                                                        Password</Link>
                                                </div>
                                            </div>
                                            ...
                                            <div className="dropdown">
                                                ...
                                                <div
                                                    className={classname("dropdown-menu", {show: this.state.utilityState})}>
                                                    <Link to="pages-starter" className="dropdown-item">Starter
                                                        Page</Link>
                                                    <Link to="pages-maintenance"
                                                          className="dropdown-item">Maintenance</Link>
                                                    <Link to="pages-comingsoon" className="dropdown-item">Coming
                                                        Soon</Link>
