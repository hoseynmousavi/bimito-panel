                                            ...
                                            <TabContent activeTab={this.state.activeTab}>
                                                    ...
                                                    <div>
                                                        ...
                                                        <Form>
                                                            <FormGroup className="mb-4" row>
                                                                <Label htmlFor="billing-name" md="2"
                                                            ...
                                                            <FormGroup className="mb-4" row>
                                                                <Label htmlFor="billing-email-address" md="2"
                                                            ...
                                                            <FormGroup className="mb-4" row>
                                                                <Label htmlFor="billing-phone" md="2"
                                                            ...
                                                            <FormGroup className="mb-4" row>
                                                                <Label htmlFor="billing-address" md="2"
                                                            ...
                                                            <FormGroup className="mb-0" row>
                                                                <Label htmlFor="example-textarea" md="2"
                                                                       className="col-form-label">Order Notes:</Label>
                                                                <Col md="10">
                                                                    <textarea className="form-control"
                                                ...
                                                <TabPane tabId="2" id="v-pills-payment" role="tabpanel"
                                                    ...
                                                    <div>
                                                        ...
                                                        <div>
                                                            <div
                                                                className="custom-control custom-radio custom-control-inline mr-4">
                                                                <Input type="radio" value="1" id="customRadioInline1"
                                                                       name="customRadioInline1"
                                                                       className="custom-control-input"/>
                                                                <Label className="custom-control-label"
                                                                       htmlFor="customRadioInline1"><i
                                                                    className="fab fa-cc-mastercard mr-1 font-size-20 align-top"></i> Credit
                                                                    / Debit Card</Label>
                                                            </div>
                                                            <div
                                                                className="custom-control custom-radio custom-control-inline mr-4">
                                                                <Input type="radio" value="2" id="customRadioInline2"
                                                                       name="customRadioInline1"
                                                                       className="custom-control-input"/>
                                                                <Label className="custom-control-label"
                                                                       htmlFor="customRadioInline2"><i
                                                                    className="fab fa-cc-paypal mr-1 font-size-20 align-top"></i> Paypal</Label>
                                                            </div>
                                                            <div
                                                                className="custom-control custom-radio custom-control-inline mr-4">
                                                                <Input type="radio" value="3" id="customRadioInline3"
                                                                       defaultChecked name="customRadioInline1"
                                                                       className="custom-control-input"/>
                                                                <Label className="custom-control-label"
                                                                       htmlFor="customRadioInline3"><i
                                                                    className="far fa-money-bill-alt mr-1 font-size-20 align-top"></i> Cash
                                                                    on Delivery</Label>
                                                            </div>
                                                        </div>
                                                                ...
                                                                <Row>
                                                                    <Col lg="6">
                                                                        <FormGroup className="mt-4 mb-0">
                                                                            <Label htmlFor="cardnameInput">Name on
                                                                                card</Label>
                                                                            <Input type="text" className="form-control"
                                                                                   id="cardnameInput"
                                                                    ...
                                                                    <Col lg="3">
                                                                        <FormGroup className=" mt-4 mb-0">
                                                                            <Label htmlFor="expirydateInput">Expiry
                                                                                date</Label>
                                                                            <Input type="text" className="form-control"
                                                                                   id="expirydateInput"
                                                                                   placeholder="MM/YY"/>
                                                                    ...
                                                                    <Col lg="3">
                                                                        <FormGroup className="mt-4 mb-0">
                                                                            <Label htmlFor="cvvcodeInput">CVV
                                                                                Code</Label>
                                                                            <Input type="text" className="form-control"
                                                                                   id="cvvcodeInput"
                                                        ...
                                                        <CardBody>
                                                            ...
                                                            <div className="table-responsive">
                                                                <Table className="table-centered mb-0 table-nowrap">
                                                                    ...
                                                                    <tbody>
                                                                    {
                                                                        this.state.orderSummary.map((orderitem, key) =>
                                                                            <tr key={"_orderSummary_" + key}>
                                                                                <th scope="row"><img src={orderitem.img}
                                                                                                     alt="product-img"
                                                                                                     title="product-img"
                                                                                                     className="avatar-md"/>
                                                                                </th>
                                                                                <td>
                                                                                    <h5 className="font-size-14 text-truncate">
                                                                                        <a href="ecommerce-product-detail.html"
                                                                                           className="text-dark">{orderitem.productTitle} </a>
                                                                                    </h5>
                                                                    ...
                                                                    <tr>
                                                                        <td colSpan="2">
                                                                            <h6 className="m-0 text-right">Sub
                                                                                Total:</h6>
                                                                        </td>
                                                                        <td>
                                                                            $ 675
                                                                    ...
                                                                    <tr>
                                                                        <td colSpan="3">
                                                                            <div
                                                                                className="bg-soft-primary p-3 rounded">
                                                                                <h5 className="font-size-14 text-primary mb-0">
                                                                                    <i className="fas fa-shipping-fast mr-2"></i> Shipping <span
                                                                                    className="float-right">Free</span>
                                                                                </h5>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                    ...
                                    <Row className="my-4">
                                        <Col sm="6">
                                            <Link to="/ecommerce-cart"
                                                ...
                                                <i className="mdi mdi-arrow-left mr-1"></i> Back to Shopping Cart
                                            </Link>
                                        </Col>
                                        <Col sm="6">
