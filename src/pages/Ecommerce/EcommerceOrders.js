                                            ...
                                            <Col sm="8">
                                                <div className="text-sm-right">
                                                    <Button type="button" color="success"
                                                        ...
                                                        className="mdi mdi-plus mr-1"></i> Add New Order</Button>
                                                </div>
                                            </Col>
                                        </Row>
                                                ...
                                                <tbody>
                                                {
                                                    this.state.Orders.map((order, key) =>
                                                        <tr key={"_order_" + key}>
                                                            <td>
                                                                <div className="custom-control custom-checkbox">
                                                                    <Input type="checkbox"
                                                                           ...
                                                                           id={order.id}/>
                                                                    <Label className="custom-control-label"
                                                                           htmlFor={order.id}>&nbsp;</Label>
                                                                </div>
                                                            </td>
                                                            <td><Link to="#"
                                                                      className="text-body font-weight-bold">{order.orderId}</Link>
                                                            </td>
                                                            ...
                                                            <td>
                                                                <Badge
                                                                    className={"font-size-12 badge-soft-" + order.badgeclass}
                                                                    color={order.badgeClass}
                                                                    pill>{order.paymentStatus}</Badge>
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <Link to="#" className="mr-3 text-primary">
                                                                    <i className="mdi mdi-pencil font-size-18 mr-3"
                                                                       id="edittooltip"></i>
                                                                ...
                                                                <Link to="#" className="text-danger">
                                                                    <i className="mdi mdi-close font-size-18 mr-3"
                                                                       id="deletetooltip"></i>
                                                                    <UncontrolledTooltip placement="top"
                            ...
                            <div className="table-responsive">
                                <Table className="table table-centered table-nowrap">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div>
                                                <h5 className="text-truncate font-size-14">Wireless Headphone
                                                    (Black)</h5>
