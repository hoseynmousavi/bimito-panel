                                            ...
                                            <Col sm="8">
                                                <div className="text-sm-right">
                                                    <Button type="button" color="success"
                                                        ...
                                                        className="mdi mdi-plus mr-1"></i> New Customers</Button>
                                                </div>
                                            </Col>
                                        </Row>
                                        ...
                                        <div className="table-responsive">
                                            <Table className="table-centered table-nowrap">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><Badge color="success" className="font-size-12"><i
                                                        className="mdi mdi-star mr-1"></i> 4.2</Badge></td>
                                                    <td>$5,412</td>
                                                    <td>07 Oct, 2019</td>
                                                    <td>
                                                        <UncontrolledDropdown>
                                                            ...
                                                            <DropdownMenu right>
                                                                <DropdownItem href="#"><i
                                                                    className="mdi mdi-pencil font-size-16 text-success mr-2"></i>Edit</DropdownItem>
                                                                <DropdownItem href="#"><i
                                                                    className="mdi mdi-trash-can font-size-16 text-danger mr-2"></i>Delete</DropdownItem>
                                                            </DropdownMenu>
                                                        </UncontrolledDropdown>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td><Badge color="success" className="font-size-12"><i
                                                        className="mdi mdi-star mr-1"></i> 4.0</Badge></td>
                                                    <td>$5,632</td>
                                                    <td>06 Oct, 2019</td>
                                                    <td>
                                                        <UncontrolledDropdown>
                                                            ...
                                                            <DropdownMenu right>
                                                                <DropdownItem href="#"><i
                                                                    className="fas fa-pencil-alt text-success mr-1"></i>Edit</DropdownItem>
                                                                <DropdownItem href="#"><i
                                                                    className="fas fa-trash-alt text-danger mr-1"></i>Delete</DropdownItem>
                                                            </DropdownMenu>
                                                        </UncontrolledDropdown>
                                                    </td>
                                                </tr>
