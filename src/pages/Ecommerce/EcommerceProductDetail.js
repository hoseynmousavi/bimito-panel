                                        ...
                                        <Row>
                                                    ...
                                                    <Row>
                                                        <Col md="2" xs="3">
                                                            <Nav className="flex-column" pills>
                                                                <NavItem>
                                                                    ...
                                                                    >
                                                                        <img src={img7} alt="" onClick={() => {
                                                                            this.imageShow(img7, 1)
                                                                        }}
                                                                ...
                                                                <NavItem>
                                                                    ...
                                                                    >
                                                                        <img src={img8} alt="" onClick={() => {
                                                                            this.imageShow(img8, 2)
                                                                        }}
                                                                             className="img-fluid mx-auto d-block rounded"/>
                                                                    </NavLink>
                                                                </NavItem>
                                                        ...
                                                        <Col md={{size: 7, offset: 1}} xs="9">
                                                            <TabContent activeTab={this.state.activeTab}>
                                                                <TabPane tabId="1">
                                                                    <div>
                                                                        <img src={img7} alt="" id="expandedImg1"
                                                                             className="img-fluid mx-auto d-block"/>
                                                                    </div>
                                                                </TabPane>
                                                                <TabPane tabId="2">
                                                                    <div>
                                                                        <img src={img8} id="expandedImg2" alt=""
                                                                             className="img-fluid mx-auto d-block"/>
                                                                    </div>
                                                                </TabPane>
                                                                <TabPane tabId="3">
                                                                    <div>
                                                                        <img src={img7} id="expandedImg3" alt=""
                                                                             className="img-fluid mx-auto d-block"/>
                                                                    </div>
                                                                </TabPane>
                                                                <TabPane tabId="4">
                                                                    <div>
                                                                        <img src={img8} id="expandedImg4" alt=""
                                                                             className="img-fluid mx-auto d-block"/>
                                                                    </div>
                                                                </TabPane>
                                                            </TabContent>
                                            ...
                                            <Col xl="6">
                                                <div className="mt-4 mt-xl-3">
                                                    ...
                                                    <h5 className="mb-4">Price : <span className="text-muted mr-2"><del>$240 USD</del></span>
                                                        <b>$225 USD</b></h5>
                                                    <p className="text-muted mb-4">To achieve this, it would be
                                                        necessary to have uniform grammar pronunciation and more common
                                                        words If several languages coalesce</p>
                                                    <Row className="mb-3">
                                                        <Col md="6">
                                                            <div>
                                                                <p className="text-muted"><i
                                                                    className="bx bx-unlink font-size-16 align-middle text-primary mr-1"></i> Wireless
                                                                </p>
                                                                <p className="text-muted"><i
                                                                    className="bx bx-shape-triangle font-size-16 align-middle text-primary mr-1"></i> Wireless
                                                                    Range : 10m</p>
                                                                <p className="text-muted"><i
                                                                    className="bx bx-battery font-size-16 align-middle text-primary mr-1"></i> Battery
                                                                    life : 6hrs</p>
                                                            </div>
                                                        </Col>
                                                        <Col md="6">
                                                            <div>
                                                                <p className="text-muted"><i
                                                                    className="bx bx-user-voice font-size-16 align-middle text-primary mr-1"></i> Bass
                                                                </p>
                                                                <p className="text-muted"><i
                                                                    className="bx bx-cog font-size-16 align-middle text-primary mr-1"></i> Warranty
                                                                    : 1 Year</p>
                                                            </div>
                                                        </Col>
                                                    </Row>
