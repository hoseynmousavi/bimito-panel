                                                ...
                                                <tbody>
                                                {
                                                    this.state.productList.map((product) =>
                                                        <tr key={product.id}>
                                                            ...
                                                            <td>
                                                                <h5 className="font-size-14 text-truncate"><Link
                                                                    to={"/ecommerce-product-detail/" + product.id}
                                                                    className="text-dark">{product.name}</Link></h5>
                                                                <p className="mb-0">Color : <span
                                                                    className="font-weight-medium">{product.color}</span>
                                                                </p>
                                                            </td>
                                                            <td>
                                                                $ {product.price}
                                                                    ...
                                                                    <InputGroup>
                                                                        <InputGroupAddon addonType="prepend">
                                                                            <Button color="primary" onClick={() => {
                                                                                this.countUP(product.id, product.data_attr)
                                                                            }}>+</Button>
                                                                        </InputGroupAddon>
                                                                        <Input type="text" value={product.data_attr}
                                                                               name="demo_vertical"/>
                                                                        <InputGroupAddon addonType="prepend">
                                                                            <Button color="primary" onClick={() => {
                                                                                this.countDown(product.id, product.data_attr)
                                                                            }}>-</Button>
                                                                        </InputGroupAddon>
                                                                    </InputGroup>
                                                                </div>
                                                            ...
                                                            <td>
                                                                <Link to="#"
                                                                      ...
                                                                      className="action-icon text-danger"> <i
                                        ...
                                        <Row className="mt-4">
                                            <Col sm="6">
                                                <Link to="/ecommerce-products" className="btn btn-secondary">
                                                    <i className="mdi mdi-arrow-left mr-1"></i> Continue Shopping
                                                </Link>
                                            </Col>
                                            <Col sm="6">
