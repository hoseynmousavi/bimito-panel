                            ...
                            <Col>
                                <Card>
                                    <CardBody>
                                        ...
                                        <CardSubtitle className="mb-3">Here are examples
                                            of <code>.form-control</code> applied to each
                                            textual HTML5 <code>&lt;input&gt;</code> <code>type</code>.</CardSubtitle>

                                        <div className="form-group row">
                                            <label htmlFor="example-text-input"
                                                   className="col-md-2 col-form-label">Text</label>
                                        ...
                                        <div className="form-group row">
                                            <label htmlFor="example-url-input"
                                                   className="col-md-2 col-form-label">URL</label>
                                            <div className="col-md-10">
                                        ...
                                        <div className="form-group row">
                                            <label htmlFor="example-datetime-local-input"
                                                   className="col-md-2 col-form-label">Date and time</label>
                                            <div className="col-md-10">
                                        ...
                                        <div className="form-group row">
                                            <label htmlFor="example-date-input"
                                                   className="col-md-2 col-form-label">Date</label>
                                            <div className="col-md-10">
                                        ...
                                        <div className="form-group row">
                                            <label htmlFor="example-month-input"
                                                   className="col-md-2 col-form-label">Month</label>
                                            <div className="col-md-10">
                                                <input className="form-control" type="month" defaultValue="2019-08"
                                                       id="example-month-input"/>
                                            </div>
                                        </div>
                                        <div className="form-group row">
                                            <label htmlFor="example-week-input"
                                                   className="col-md-2 col-form-label">Week</label>
                                            <div className="col-md-10">
                                                <input className="form-control" type="week" defaultValue="2019-W33"
                                                       id="example-week-input"/>
                                            </div>
                                        </div>
                                        <div className="form-group row">
                                            <label htmlFor="example-time-input"
                                                   className="col-md-2 col-form-label">Time</label>
                                            <div className="col-md-10">
                                                <input className="form-control" type="time" defaultValue="13:45:00"
                                                       id="example-time-input"/>
                                            </div>
                                        </div>
                                        <div className="form-group row">
                                            <label htmlFor="example-color-input"
                                                   className="col-md-2 col-form-label">Color</label>
                                            <div className="col-md-10">
                                                <input className="form-control" type="color" defaultValue="#556ee6"
                            ...
                            <Col lg={6}>
                                <Card>
                                    <CardBody>
                                        ...
                                        <CardSubtitle className="mb-3">Set heights using classNamees
                                            like <code>.form-control-lg</code> and <code>.form-control-sm</code>.</CardSubtitle>
                                        <div>
                                            <div className="mb-4">
                                                <input className="form-control" type="text"
                            ...
                            <Col lg={6}>
                                <Card>
                                    <CardBody>
                                        ...
                                        <CardSubtitle className="mb-3">Set horizontally scrollable range inputs
                                            using <code>.form-control-range</code>.</CardSubtitle>
                                        ...
                                        <div className="mt-4">
                                            ...
                                            <input type="range" className="custom-range mt-4" min="0" max="5"
                                                   id="customRange2"/>
                                        </div>
                                    </CardBody>
                                </Card>
                                                ...
                                                <div className="mt-4 mt-lg-0">
                                                    ...
                                                    <div className="custom-control custom-checkbox mb-3">
                                                        <input type="checkbox" className="custom-control-input"
                                                               id="CustomCheck1" onChange={() => false}
                                                    ...
                                                    <div
                                                        className="custom-control custom-checkbox custom-control-right">
                                                        <input type="checkbox" className="custom-control-input"
                                                               id="customCheck2"/>
                                                        <label className="custom-control-label" htmlFor="customCheck2">Custom
                                                ...
                                                <div className="mt-4 mt-lg-0">
                                                    ...
                                                    <div className="custom-control custom-radio custom-control-right">
                                                        ...
                                                        <label className="custom-control-label" htmlFor="customRadio2">Or
                                                            toggle this Right custom radio</label>
                                                    </div>
                                                </div>
                                            </Col>
                                        </Row>
                            ...
                            <Col lg={6}>
                                <Card>
                                    <CardBody>
                                        ...
                                        <CardSubtitle className="mb-3">A switch has the markup of a custom checkbox but
                                            uses the <code>.custom-switch</code> className to render a toggle switch.
                                            Switches also support the <code>disabled</code> attribute.</CardSubtitle>
                            ...
                            <Col lg={6}>
                                <Card>
                                    <CardBody>
                                        ...
                                        <CardSubtitle className="mb-3">The file input is the most gnarly of the bunch
                                            and requires additional JavaScript if you’d like to hook them up with
                                            functional <em>Choose file…</em> and selected file name text.</CardSubtitle>
