        ...
        <form onSubmit={handleSubmit}>
            ...
            <fieldset>
                <Row>
                    ...
                    <Col md={6}>
                        <div className="form-group row">
                            <label htmlFor="ddlCreditCardType" className="col-lg-3 col-form-label">Credit Card
                                Type</label>
                            <Col lg={9}>
                ...
                <Row>
                    <Col md={6}>
                        <div className="form-group row">
                            <label htmlFor="txtCreditCardNumber" className="col-lg-3 col-form-label">Credit Card
                                Number</label>
                            <Col lg={9}>
                    ...
                    <Col md={6}>
                        <div className="form-group row">
                            <label htmlFor="txtCardVerificationNumber" className="col-lg-3 col-form-label">Card
                ...
                <Row>
                    <Col md={6}>
                        <div className="form-group row">
                            <label htmlFor="txtExpirationDate" className="col-lg-3 col-form-label">Expiration
                                Date</label>
                            <Col lg={9}>
