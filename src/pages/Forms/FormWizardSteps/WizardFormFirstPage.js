        ...
        <form onSubmit={handleSubmit}>
            ...
            <fieldset>
                <Row>
                    <Col md={6}>
                        <Row className="form-group">
                            <label htmlFor="txtFirstNameBilling" className="col-lg-3 col-form-label">Contact
                                Person</label>
                            <Col lg={9}>
                ...
                <Row>
                    ...
                    <Col md={6}>
                        <Row className="form-group">
                            <label htmlFor="txtEmailAddressBilling" className="col-lg-3 col-form-label">Email
                                Address</label>
                            <Col lg={9}>
                ...
                <Row>
                    <Col md={6}>
                        <Row className="form-group">
                            ...
                            <Col lg={9}>
                                <textarea id="txtAddress1Billing" name="txtAddress1Billing" rows="4"
                    ...
                    <Col md={6}>
                        <Row className="form-group">
                            <label htmlFor="txtAddress2Billing" className="col-lg-3 col-form-label">Warehouse
                                Address</label>
                            <Col lg={9}>
                                <textarea id="txtAddress2Billing" name="txtAddress2Billing" rows="4"
                                          className="form-control"></textarea>
                            </Col>
                        </Row>
                    </Col>
                ...
                <Row>
                    ...
                    <Col md={6}>
                        <Row className="form-group">
                            <label htmlFor="txtStateProvinceBilling" className="col-lg-3 col-form-label">Live Market
                                A/C</label>
                            <Col lg={9}>
                ...
                <Row>
                    <Col md={6}>
                        <Row className="form-group">
                            <label htmlFor="txtTelephoneBilling" className="col-lg-3 col-form-label">Product
                                Category</label>
                            <Col lg={9}>
                    ...
                    <Col md={6}>
                        <Row className="form-group">
                            <label htmlFor="txtFaxBilling" className="col-lg-3 col-form-label">Product Sub
                                Category</label>
                            <Col lg={9}>
            ...
            <div id="btn_div" className="float-right">
                <button type="button" className="btn btn-primary previous" disabled
                        style={{cursor: "no-drop"}}> Previous
                </button>
                &nbsp;
