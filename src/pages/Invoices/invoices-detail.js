                                    ...
                                    <CardBody>
                                        ...
                                        <div className="table-responsive">
                                            <Table className="table-nowrap">
                                                ...
                                                <tr>
                                                    ...
                                                    <td className="border-0 text-right"><h4
                                                        className="m-0">$1410.00</h4></td>
                                                </tr>
                                                </tbody>
                                            </Table>
                                        </div>
                                        <div className="d-print-none">
                                            <div className="float-right">
                                                <Link to="#" onClick={this.printInvoice}
                                                      className="btn btn-success waves-effect waves-light mr-2"><i
                                                    className="fa fa-print"></i></Link>
                                                <Link to="#"
                                                      className="btn btn-primary w-md waves-effect waves-light">Send</Link>
                                            </div>
                                        </div>
                                    </CardBody>
                                </Card>
