                    ...
                    <Card>
                        <CardBody>
                            <Row>
                                    ...
                                    <div className="text-lg-center">
                                        {
                                            this.props.data.image !== "Null"
                                                ? <img src={this.props.data.image}
                                                       ...
                                                       alt="img"/>
                                                : <div
                                                    className="avatar-sm mr-3 mx-lg-auto mb-4 float-left float-lg-none">
                                                    <span
                                                        className={"avatar-title rounded-circle bg-soft-" + this.props.data.color + " text-primary font-size-16"}>
                                                        {nameIcon}
                                                    </span>
                                                </div>
                                        }
                                ...
                                <Col lg="8">
                                    <div>
                                        <Link to="/invoices-detail" className="d-block text-primary mb-2">Invoice
                                            #{this.props.data.invoiceID}</Link>
                                        ...
                                        <ul className="list-inline mb-0">
                                            ...
                                            <li className="list-inline-item">
                                                <h5 className="font-size-14" id="duedateTooltip"><i
                                                    className="bx bx-calendar mr-1 text-primary"></i>
