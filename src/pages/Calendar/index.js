                                    ...
                                    <CardBody>
                                        <Row>
                                                ...
                                                <div id="external-events" className="mt-3">
                                                    ...
                                                    {this.state.categories.map((category, i) => {
                                                        return <div
                                                            ...
                                                            key={"cat-" + category.id}
                                                            draggable onDrag={(event) => this.onDrag(event, category)}
                                            ...
                                            <Col className="col-lg-9">
                                                ...
                                                <FullCalendar ref={this.calendarComponentRef} defaultView="dayGridMonth"
                                                ...
                                                <Modal isOpen={this.state.modal} toggle={this.toggle}
                                                    ...
                                                    <ModalBody>
                                                        <AvForm onValidSubmit={this.handleValidEventSubmit}>
                                                            <Row form>
                                                                <Col className="col-12">
                                                                    <AvField name="title" label="Event Name" type="text"
                                                            ...
                                                            <Row>
                                                                <Col>
                                                                    <div className="text-right">
                                                                        ...
                                                                        <button type="submit"
                                                                                className="btn btn-success save-event">Save
                                                                        </button>
                                                                    </div>
                                                                </Col>
                                                            </Row>
                                                ...
                                                <Modal isOpen={this.state.modalcategory} toggle={this.togglecategory}
                                                       className={this.props.className}>
                                                    ...
                                                    <ModalBody>
                                                        <AvForm onValidSubmit={this.handleValidEventSubmitcategory}>
                                                            <Row form>
                                                                <Col className="col-12">
                                                                    <AvField name="title_category" label="Category Name"
                                                                ...
                                                                <Col className="col-12">
                                                                    <AvField type="select" name="event_category"
                                                            ...
                                                            <Row>
                                                                <Col>
                                                                    <div className="text-right">
                                                                        <button type="button"
                                                                                className="btn btn-light mr-2"
                                                                                onClick={this.togglecategory}>Close
                                                                        </button>
                                                                        <button type="submit"
                                                                                className="btn btn-success save-event">Save
                                                                        </button>
