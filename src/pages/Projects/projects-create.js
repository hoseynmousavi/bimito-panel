                                    ...
                                    <CardBody>
                                        ...
                                        <Form>
                                            <FormGroup className="mb-4" row>
                                                <Label htmlFor="projectname" className="col-form-label col-lg-2">Project
                                                    Name</Label>
                                                <Col lg="10">
                                            ...
                                            <FormGroup className="mb-4" row>
                                                <Label htmlFor="projectdesc" className="col-form-label col-lg-2">Project
                                                    Description</Label>
                                                <Col lg="10">
                                                    <textarea className="form-control" id="projectdesc" rows="3"
                                            ...
                                            <FormGroup className="mb-4" row>
                                                ...
                                                <Col lg="10">
                                                    <Row>
                                                        ...
                                                        <Col md={6} className="pl-0"> <DatePicker
                                                            className="form-control"
