                                    ...
                                    <Media>
                                        ...
                                        <Media className="overflow-hidden" body>
                                            <h5 className="text-truncate font-size-15"><Link to="#"
                                                                                             className="text-dark">{project.name}</Link>
                                            </h5>
                                                    ...
                                                    project.child.map((team, key) =>
                                                        team.img !== "Null"
                                                            ...
                                                            <Link to="#" className="team-member d-inline-block"
                                                                  id={"member" + team.id} key={"_team_" + key}>
                                                                <img src={team.img}
                                                            ...
                                                            <Link to="#" className="team-member d-inline-block"
                                                                ...
                                                                <div className="avatar-xs m-1">
                                                                    <span
                                                                        className={"avatar-title rounded-circle bg-soft-" + team.color + " text-" + team.color + " font-size-16"}>
                                                                        {team.name.charAt(0)}
                                                                    </span>
                                                                    <UncontrolledTooltip placement="top"
                                                                                         target={"member" + team.id}>
