                                    ...
                                    <CardBody>
                                        <Media>
                                            ...
                                            <Media className="overflow-hidden" body>
                                                ...
                                                <p className="text-muted">Separate existence is a myth. For science,
                                                    music, sport, etc.</p>
                                            </Media>
                                        </Media>
                                        ...
                                        <p className="text-muted">To an English person, it will seem like simplified
                                            ...
                                            existence is a myth. For science, music, sport, etc,</p>

                                        <div className="text-muted mt-4">
                                            <p><i className="mdi mdi-chevron-right text-primary mr-1"></i> To achieve
                                                this, it would be necessary</p>
                                            <p><i className="mdi mdi-chevron-right text-primary mr-1"></i> Separate
                                                existence is a myth.</p>
                                            <p><i className="mdi mdi-chevron-right text-primary mr-1"></i> If several
                                        ...
                                        <Row className="task-dates">
                                            <Col sm="6" xs="6">
                                                <div className="mt-4">
                                                    <h5 className="font-size-14"><i
                                                        className="bx bx-calendar mr-1 text-primary"></i> Start Date
                                                    </h5>
                                            ...
                                            <Col sm="6" xs="6">
                                                <div className="mt-4">
                                                    <h5 className="font-size-14"><i
                                                        className="bx bx-calendar-check mr-1 text-primary"></i> Due Date
                                                    </h5>
                                                ...
                                                <tbody>
                                                {
                                                    this.state.members.map((member) =>
                                                        <tr>
                                                            ...
                                                            <td><h5 className="font-size-14 m-0"><Link to=""
                                                                                                       className="text-dark">{member.name}</Link>
                                                            </h5></td>
                                                            <td>
                                                                <div>
                                                                    {
                                                                        member.skills.map((skill) =>
                                                                            <Link to="#"
                                                                                  className="badge badge-primary font-size-11">{skill.name}</Link>
                                                                        )
                                                                    }
                                                                </div>
                                                            </td>
                                                ...
                                                <tbody>
                                                {
                                                    this.state.files.map((file) =>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <h5 className="font-size-14 mb-1"><Link to="#"
                                                                                                        className="text-dark">{file.name}</Link>
                                                                </h5>
                                                                <small>Size : {file.size}</small>
                                                            </td>
                                                            <td>
                                                                <div className="text-center">
                                                                    <Link to={file.link} className="text-dark"><i
                                ...
                                <Card>
                                    <CardBody>
                                        ...
                                        <Media className="mb-4">
                                            <div className="mr-3">
                                                <img className="media-object rounded-circle avatar-xs" alt=""
                                                     src={avatar2}/>
                                            </div>
                                            <Media body>
