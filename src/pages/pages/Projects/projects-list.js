                                    ...
                                    <div className="table-responsive">
                                        <Table
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 className="text-truncate font-size-14"><Link to="#"
                                                                                                     className="text-dark">New
                                                        admin Design</Link></h5>
                                                    <p className="text-muted mb-0">It will be as simple as
                                                        Occidental</p>
                                                </td>
                                                <td>15 Oct, 19</td>
                                                ...
                                                <td>
                                                    <div className="team">
                                                        <Link to="javascript: void(0);"
                                                              className="team-member d-inline-block" id="member1">
                                                            <img src={avatar2} className="rounded-circle avatar-xs m-1"
                                                                 alt=""/>
                                                        ...
                                                        <Link to="javascript: void(0);"
                                                              className="team-member d-inline-block" id="member2">
                                                            <img src={avatar1} className="rounded-circle avatar-xs m-1"
                                                                 alt=""/>
                                                ...
                                                <td>
                                                    <div className="team">
                                                        <Link to="#" className="team-member d-inline-block"
                                                              id="member3">
                                                            <img src={avatar3} className="rounded-circle avatar-xs m-1"
                                                                 alt=""/>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div className="team">
                                                        <Link to="javascript: void(0);"
                                                              className="team-member d-inline-block" id="member4">
                                                            <img src={avatar5} className="rounded-circle avatar-xs m-1"
                                                                 alt=""/>
                                                        ...
                                                        <Link to="javascript: void(0);"
                                                              className="team-member d-inline-block" id="member5">
                                                            <div className="avatar-xs m-1">
                                                                    <span
                                                                        className="avatar-title rounded-circle bg-soft-primary text-primary font-size-16">
                                                                        A
                                                                    </span>
                                                            </div>
                                                        ...
                                                        <Link to="#" className="team-member d-inline-block"
                                                              id="member6">
                                                            <img src={avatar4} className="rounded-circle avatar-xs m-1"
                                                                 alt=""/>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 className="text-truncate font-size-14"><Link to="#"
                                                                                                     className="text-dark">Redesign
                                                        - Landing page</Link></h5>
                                                ...
                                                <td>
                                                    <div className="team">
                                                        <Link to="#" className="team-member d-inline-block"
                                                              id="member7">
                                                            <img src={avatar6} className="rounded-circle avatar-xs m-1"
                                                                 alt=""/>
                                                        ...
                                                        <Link to="javascript: void(0);"
                                                              className="team-member d-inline-block" id="member8">
                                                            <div className="avatar-xs m-1">
                                                                    <span
                                                                        className="avatar-title rounded-circle bg-soft-success text-success font-size-16">
                                                                        D
                                                                    </span>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 className="text-truncate font-size-14"><Link to="#"
                                                                                                     className="text-dark">Skote
                                                        Dashboard UI</Link></h5>
                                                ...
                                                <td>
                                                    <div className="team">
                                                        <Link to="javascript: void(0);"
                                                              className="team-member d-inline-block" id="member9">
                                                            <img src={avatar7} className="rounded-circle avatar-xs m-1"
                                                                 alt=""/>
                                                        ...
                                                        <Link to="javascript: void(0);"
                                                              className="team-member d-inline-block" id="member10">
                                                            <img src={avatar8} className="rounded-circle avatar-xs m-1"
                                                                 alt=""/>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div className="team">
                                                        <Link to="javascript: void(0);"
                                                              className="team-member d-inline-block" id="member11">
                                                            <div className="avatar-xs m-1">
                                                                    <span
                                                                        className="avatar-title rounded-circle bg-soft-danger text-danger font-size-16">
                                                                        K
                                                                    </span>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 className="text-truncate font-size-14"><Link to="#"
                                                                                                     className="text-dark">Multipurpose
                                                        Landing</Link></h5>
                                                    <p className="text-muted mb-0">It will be as simple as
                                                        Occidental</p>
                                                </td>
                                                ...
                                                <td>
                                                    <div className="team">
                                                        <Link to="javascript: void(0);"
                                                              className="team-member d-inline-block" id="member12">
                                                            <img src={avatar3} className="rounded-circle avatar-xs m-1"
                                                                 alt=""/>
                            ...
                            <Col xs="12">
                                <div className="text-center my-3">
                                    <Link to="#" className="text-success"><i
                                        className="bx bx-loader bx-spin font-size-18 align-middle mr-2"></i> Load more
                                    </Link>
                                </div>
                            </Col>
                        </Row>
