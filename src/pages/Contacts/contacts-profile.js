                            ...
                            <Col xl="4">
                                        ...
                                        <Row>
                                            ...
                                            <Col sm={8}>
                                                <div className="pt-4">
                                                    ...
                                                    <div className="mt-4">
                                                        <Link to=""
                                                              className="btn btn-primary waves-effect waves-light btn-sm">View
                                ...
                                <Card>
                                    <CardBody>
                                        ...
                                        <p className="text-muted mb-4">Hi I'm Cynthia Price,has been the industry's
                                            standard dummy text To an English person, it will seem like simplified
                                            ...
                                            <ul className="verti-timeline list-unstyled">
                                                {
                                                    this.state.experiences.map((experience, i) =>
                                                        <li className={experience.id === 1 ? "event-list active" : "event-list"}
                                                            key={"_exp_" + i}>
                                                            ...
                                                            <Media>
                                                                ...
                                                                <Media body>
                                                                    <div>
                                                                        <h5 className="font-size-15"><Link
                                                                            to={experience.link}
                                                                            className="text-dark">{experience.designation}</Link>
                                                                        </h5>
                                                                        <span
                                                                            className="text-primary">{experience.timeDuration}</span>
                                                                    </div>
                                                                </Media>
                                                            </Media>
                                                        </li>
                                ...
                                <Row>
                                    {
                                        this.state.miniCards.map((card, key) =>
                                            <MiniCards title={card.title} text={card.text} iconClass={card.iconClass}
                                                       key={"_card_" + key}/>
                                        )
                                    }
