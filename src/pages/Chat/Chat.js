                                                ...
                                                <Media>
                                                    ...
                                                    <Media body>
                                                        ...
                                                        <p className="text-muted mb-0"><i
                                                            className="mdi mdi-circle text-success align-middle mr-1"></i> Active
                                                        </p>
                                                    </Media>

                                                    <div>
                                                        <Dropdown isOpen={this.state.notification_Menu}
                                                            ...
                                                            <DropdownMenu right>
                                                                ...
                                                                <DropdownItem href="#">Something else
                                                                    here</DropdownItem>
                                                            </DropdownMenu>
                                                        </Dropdown>
                                                    </div>
                                                                            ...
                                                                            <li key={chat.id + chat.status}
                                                                                ...
                                                                                <Link to="#" onClick={() => {
                                                                                    ...
                                                                                    <Media>
                                                                                        ...
                                                                                        <div
                                                                                            className="font-size-11">{chat.time}</div>
                                                                                    </Media>
                                                                                </Link>
                                                                            </li>
                                                                        )
                                                    ...
                                                    <Col md="8" xs="3">
                                                        <ul className="list-inline user-chat-nav text-right mb-0">
                                                            <li className="list-inline-item d-none d-sm-inline-block">
                                                                <Dropdown isOpen={this.state.search_Menu}
                                                            ...
                                                            <li className="list-inline-item  d-none d-sm-inline-block">
                                                                <Dropdown isOpen={this.state.settings_Menu}
                                                                          toggle={this.toggleSettings}>
                                                                    <DropdownToggle className="btn nav-btn" tag="i">
                                                                        <i className="bx bx-cog"></i>
                                                                    </DropdownToggle>
                                                                    <DropdownMenu right>
                                                                        <DropdownItem href="#">View
                                                            ...
                                                            <li className="list-inline-item">
                                                                <Dropdown isOpen={this.state.other_Menu}
                                                                        ...
                                                                        <div className="conversation-list">
                                                                            <UncontrolledDropdown>
                                                                                ...
                                                                                <DropdownMenu direction="right">
                                                                                    <DropdownItem
                                                                                        href="#">Copy</DropdownItem>
                                                                                    <DropdownItem
                                                                                        href="#">Save</DropdownItem>
                                                                                    <DropdownItem
                                                                                        href="#">Forward</DropdownItem>
                                                                                    <DropdownItem
                                                                            ...
                                                                            <div className="ctext-wrap">
                                                                                <div
                                                                                    className="conversation-name">{message.name}</div>
                                                                                <p>
                                                                                    {message.message}
                                                                                </p>
                                                                                <p className="chat-time mb-0"><i
                                                                                    className="bx bx-time-five align-middle mr-1"></i> {message.time}
                                                                                </p>
                                                                            </div>
                                                    ...
                                                    <Row>
                                                        ...
                                                        <Col className="col-auto">
                                                            <Button type="button" color="primary"
                                                                    ...
                                                                    className="btn-rounded chat-send w-md waves-effect waves-light"><span
                                                                className="d-none d-sm-inline-block mr-2">Send</span> <i
