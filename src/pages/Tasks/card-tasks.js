                                        ...
                                        <tr>
                                                ...
                                                <div className="custom-control custom-checkbox">
                                                    {
                                                        task.isChecked
                                                            ? <Input type="checkbox" className="custom-control-input"
                                                                     checked id={"customCheck1_" + task.id}/>
                                                            : <Input type="checkbox" className="custom-control-input"
                                                                     id={"customCheck1_" + task.id}/>
                                                    }
                                                    <Label className="custom-control-label"
                                                           htmlFor={"customCheck1_" + task.id}></Label>
                                                </div>
                                            </td>
                                            <td>
                                                <h5 className="text-truncate font-size-14 m-0"><Link to="#"
                                                                                                     className="text-dark">{task.title}</Link>
                                                </h5>
                                            </td>
                                            <td>
                                                <div className="team">
                                            ...
                                            <td>
                                                <div className="text-center">
                                                    <Badge color={task.color}
                                                           className={"badge-soft-" + task.color + " font-size-11"}
                                                           pill>{task.tastStatus}</Badge>
                                                </div>
                                            </td>
                                        </tr>
                                    )
