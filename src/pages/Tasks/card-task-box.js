                ...
                <Card className="task-box">
                    <CardBody className="borad-width">
                        <div className="float-right ml-2">
                            <Badge color="secondary" className="badge-soft-secondary font-size-12"
                                   pill>{this.props.data['status']}</Badge>
                        </div>
                        <div>
                            <h5 className="font-size-15"><Link to="#"
                                                               className="text-dark">{this.props.data['title']}</Link>
                            </h5>
