                            ...
                            <Col lg={6}>
                                <Card>
                                    <CardBody>
                                        ...
                                        <CardSubtitle className="mb-3">
                                            We only set a{" "} <code className="highlighter-rouge">height</code> value
                                            on the{" "}
                                            <code className="highlighter-rouge">.progress-bar</code>, so if you change
                                            that value the outer{" "}
                                            <code className="highlighter-rouge">.progress</code> will automatically
                                            resize accordingly.
                                        </CardSubtitle>
                            ...
                            <Col lg={6}>
                                <Card>
                                    <CardBody>
                                        ...
                                        <CardSubtitle className="mb-3">
                                            The striped gradient can also be animated. Add{" "} <code
                                            className="highlighter-rouge"> striped{" "} animated </code>{" "} to{" "} to
                                ...
                                <Card>
                                    <CardBody>
                                        ...
                                        <CardSubtitle className="mb-3">
                                            ...
                                            any{" "} to apply a stripe via CSS gradient over the progress bar’s
                                            background color.
                                        </CardSubtitle>
