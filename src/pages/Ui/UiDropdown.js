                                ...
                                <Card>
                                    <CardBody>
                                        ...
                                        <CardSubtitle className="mb-3">Any single <code
                                            ...
                                            toggle with some markup changes. Here’s how you can put them to work with
                                            either <code
                                                className="highlighter-rouge">&lt;button&gt;</code> elements:</CardSubtitle>
                                        <Row>
                                            <Col sm={6}>
                                                <Dropdown
                            ...
                            <Col lg={6}>
                                <Card>
                                    <CardBody>
                                        ...
                                        <CardSubtitle className="mb-3">The best part is you can do this with any button
                                            variant, too:</CardSubtitle>
                            ...
                            <Col lg={6}>
                                <Card>
                                    <CardBody>
                                        ...
                                        <CardSubtitle className="mb-3"> Button dropdowns work with buttons of all sizes,
                                            including default and split dropdown buttons.</CardSubtitle>
                                        <div className="btn-group mb-2">
                                            <ButtonDropdown
                            ...
                            <Col lg={6}>
                                <Card>
                                    <CardBody>
                                        ...
                                        <CardSubtitle className="mb-3">Trigger dropdown menus above elements by
                                            adding <code className="highlighter-rouge">.dropup</code> to the parent
                                ...
                                <Card>
                                    <CardBody>
                                        ...
                                        <CardSubtitle className="mb-3">Add <code
                                            className="highlighter-rouge">.dropdown-menu-right</code> to a <code
                                            className="highlighter-rouge">.dropdown-menu</code> to right align the
                                            dropdown menu.</CardSubtitle>
                                        <ButtonDropdown
                            ...
                            <Col lg={6}>
                                <Card>
                                    <CardBody>
                                        ...
                                        <CardSubtitle className="mb-3">Trigger dropdown menus at the right of the
                                            elements by adding <code>.dropright</code> to the parent
                                            element.</CardSubtitle>
                            ...
                            <Col lg={6}>
                                <Card>
                                    <CardBody>
                                        ...
                                        <CardSubtitle className="mb-3">Trigger dropdown menus at the right of the
                                            elements by adding <code>.dropleft</code> to the parent
                                            element.</CardSubtitle>
