                                    ...
                                    <CardBody>
                                        <Row>
                                            <Col lg={6}>
                                                ...
                                                <CardSubtitle className="mb-3">Add any of the below mentioned modifier
                                                    classes to change the appearance of a badge.</CardSubtitle>
                                                <div>
                                            ...
                                            <Col lg={6}>
                                                ...
                                                <CardSubtitle className="mb-3">Use the <code>.badge-pill</code> modifier
                                                    className to make
                                                ...
                                                <div className="mt-1">
                                                    <span
                                                        className="badge badge-pill badge-soft-primary">Primary</span>{' '}
                                                    <span
                                                        className="badge badge-pill badge-soft-success">Success</span>{' '}
                                                    <span className="badge badge-pill badge-soft-info">Info</span>{' '}
                                                    <span
                                                        className="badge badge-pill badge-soft-warning">Warning</span>{' '}
                                                    <span
                                                        className="badge badge-pill badge-soft-danger">Danger</span>{' '}
                            ...
                            <Col lg={6}>
                                <Card>
                                    <CardBody>
                                        ...
                                        <CardSubtitle className="mb-3">Add small overlay content, like those found in
                                            iOS, to any element for housing secondary information.</CardSubtitle>
                                        <div className="button-items">
                                            <Button id="Popovertop" color="secondary" onClick={this.toggletop}>
                                                Popover on top
                                            </Button>
                                            <Popover placement="top" isOpen={this.state.popovertop} target="Popovertop"
                                                ...
                                                <PopoverBody>Sed posuere consectetur est at lobortis. Aenean eu leo
                                                    ...
                                                    vestibulum.</PopoverBody>
                                            </Popover> &nbsp;

                                            <Button id="Popoverright" onClick={this.toggleright} color="secondary">
                                                Popover on right
                                            </Button>
                                            <Popover placement="right" isOpen={this.state.popoverright}
                                                     target="Popoverright" toggle={this.toggleright}>
                                                <PopoverHeader>Popover Title</PopoverHeader>
                                                <PopoverBody>Sed posuere consectetur est at lobortis. Aenean eu leo
                                                    quam. Pellentesque ornare sem lacinia quam venenatis
                                                    vestibulum.</PopoverBody>
                                            ...
                                            <Popover placement="bottom" isOpen={this.state.popoverbottom}
                                                     target="Popoverbottom" toggle={this.togglebottom}>
                                                <PopoverHeader>Popover Title</PopoverHeader>
                                                <PopoverBody>Sed posuere consectetur est at lobortis. Aenean eu leo
                                                    quam. Pellentesque ornare sem lacinia quam venenatis
                                                    vestibulum.</PopoverBody>
                                            ...
                                            <Popover placement="left" isOpen={this.state.popoverleft}
                                                     target="Popoverleft" toggle={this.toggleleft}>
                                                <PopoverHeader>Popover Title</PopoverHeader>
                                                <PopoverBody>Sed posuere consectetur est at lobortis. Aenean eu leo
                                                    quam. Pellentesque ornare sem lacinia quam venenatis
                                                    vestibulum.</PopoverBody>
                                            ...
                                            <Button id="Popoverdismiss" className="btn btn-success"
                                                    onClick={this.toggledismiss}>
                                                Dismissible popover
                                            </Button>
                                            <Popover onClick={this.toggledismissclose} placement="bottom"
                                                     isOpen={this.state.popoverdismiss} target="Popoverdismiss"
                            ...
                            <Col lg={6}>
                                <Card>
                                    <CardBody>
                                        ...
                                        <CardSubtitle className="mb-3">Hover over the links below to see
                                            tooltips:</CardSubtitle>

                                        <div className="button-items">
                                            <Tooltip placement="top" isOpen={this.state.tttop} target="TooltipTop"
                                                     toggle={() => this.setState({tttop: !this.state.tttop})}>Hello
                                                world!</Tooltip>
                                            <Tooltip placement="right" isOpen={this.state.ttright} target="TooltipRight"
                                                     toggle={() => this.setState({ttright: !this.state.ttright})}>Hello
                                                world!</Tooltip>
                                            <Tooltip placement="bottom" isOpen={this.state.ttbottom}
                                                     target="TooltipBottom"
                                                     toggle={() => this.setState({ttbottom: !this.state.ttbottom})}>Hello
                                                world!</Tooltip>
                                            <Tooltip placement="left" isOpen={this.state.ttleft} target="TooltipLeft"
                                                     toggle={() => this.setState({ttleft: !this.state.ttleft})}>Hello
                                                world!</Tooltip>

                                            <button type="button" className="btn btn-primary" id="TooltipTop"> Tooltip
                                                on top
                                            </button>
                                            <button type="button" className="btn btn-primary"
                                                    id="TooltipBottom"> Tooltip on Bottom
                                            </button>
                                            <button type="button" className="btn btn-primary" id="TooltipLeft"> Tooltip
                                                on Left
                                            </button>
                                            <button type="button" className="btn btn-primary" id="TooltipRight"> Tooltip
                                                on Right
                                            </button>
                                        </div>
                                    ...
                                    <CardBody>
                                        ...
                                        <Row>
                                            <Col lg={6}>
                                                ...
                                                <CardSubtitle className="mb-3">Pagination links indicate a series of
                                                    related content exists across multiple pages.</CardSubtitle>
                                                    ...
                                                    <ul className="pagination">
                                                        <li className="page-item disabled">
                                                            <Link className="page-link" to="#"
                                                                  tabIndex="-1">Previous</Link>
                                                        </li>
                                                        <li className="page-item"><Link className="page-link"
                                                                                        to="#">1</Link></li>
                                                        <li className="page-item active">
                                                            <Link className="page-link" to="#">2 <span
                                        ...
                                        <Row>
                                            <Col lg={6}>
                                                ...
                                                <CardSubtitle className="mb-3">Fancy larger or smaller pagination?
                            ...
                            <Col lg={6}>
                                <Card>
                                    <CardBody>
                                        ...
                                        <CardSubtitle className="mb-3">Use the border spinners for a lightweight loading
                                            indicator.</CardSubtitle>
                                        <div>
                            ...
                            <Col lg={6}>
                                <Card>
                                    <CardBody>
                                        ...
                                        <CardSubtitle className="mb-3">If you don’t fancy a border spinner, switch to
                                            the grow spinner. While it doesn’t technically spin, it does repeatedly
                                            grow!</CardSubtitle>
                                        <div>
