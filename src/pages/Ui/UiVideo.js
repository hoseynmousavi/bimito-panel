                            ...
                            <Col lg={6}>
                                <Card>
                                    <CardBody>
                                        ...
                                        <CardSubtitle className="mb-3">Aspect ratios can be customized with modifier
                                            classNamees.</CardSubtitle>

                                        <div className="embed-responsive embed-responsive-16by9">
                                            <iframe title="test" className="embed-responsive-item"
                                ...
                                <Card>
                                    <CardBody>
                                        ...
                                        <div className="embed-responsive embed-responsive-21by9">
                                            <iframe title="test1" className="embed-responsive-item"
                                                    src="https://www.youtube.com/embed/1y_kfWUCFDQ"></iframe>
                                        </div>
                                ...
                                <Card>
                                    <CardBody>
                                        ...
                                        <div className="embed-responsive embed-responsive-4by3">
                                            <iframe title="tes2" className="embed-responsive-item"
                                                    src="https://www.youtube.com/embed/1y_kfWUCFDQ"></iframe>
                                        </div>
                                    </CardBody>
                                </Card>
                                ...
                                <Card>
                                    <CardBody>
                                        ...
                                        <div className="embed-responsive embed-responsive-1by1">
                                            <iframe title="test3" className="embed-responsive-item"
                                                    src="https://www.youtube.com/embed/1y_kfWUCFDQ"></iframe>
                                        </div>
                                    </CardBody>
                                </Card>
