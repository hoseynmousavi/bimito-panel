                                ...
                                <Card>
                                    <CardBody>
                                        ...
                                        <CardSubtitle className="mb-3">
                                            ...
                                            compiled{" "} <code
                                            className="highlighter-rouge">bootstrap.js</code> file—to extend our
                                            navigational tabs and pills to create tabbable panes of local content, even
                                            via dropdown menus.
                                        </CardSubtitle>
                                ...
                                <Card>
                                    <CardBody>
                                        ...
                                        <CardSubtitle className="mb-3">
                                            ...
                                            compiled{" "} <code
                                            className="highlighter-rouge">bootstrap.js</code> file—to extend our
                                            navigational tabs and pills to createtabbable panes of local content, even
                                            via dropdown menus.
                                        </CardSubtitle>
                            ...
                            <Col lg={6}>
                                <Card>
                                    <CardBody>
                                        ...
                                        <CardSubtitle className="mb-3">
                                            You can use a link with the{" "} <code
                                            className="highlighter-rouge">href</code> attribute, or a button with
                                            the{" "} <code className="highlighter-rouge">data-target</code> attribute.
                                            In both cases, the{" "} <code
                                            className="highlighter-rouge"> data-toggle="collapse"</code> is required.
                                        </CardSubtitle>
