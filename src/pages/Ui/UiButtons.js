                            ...
                            <Col lg={6}>
                                <Card>
                                    <CardBody>
                                        ...
                                        <CardSubtitle className="mb-3">Bootstrap includes six predefined button styles,
                                            each serving its own semantic purpose.</CardSubtitle>
                            ...
                            <Col lg={6}>
                                <Card>
                                    <CardBody>
                                        ...
                                        <CardSubtitle className="mb-3">Add one another property like <code
                                            className="highlighter-rouge">outline</code> ones to remove all background
                                            images and colors on any button.</CardSubtitle>
                                        <div className="button-items">
                                            <Button
                                                color="primary"
                                                outline
                            ...
                            <Col lg={6}>
                                <Card>
                                    <CardBody>
                                        ...
                                        <CardSubtitle className="mb-3">Use class <code>.btn-rounded</code> for button
                                            round border.</CardSubtitle>
                                        <div className="button-items">
                                            <Link
                                                className="btn btn-primary waves-effect waves-light"
                                                to="#"
                            ...
                            <Col lg={6}>
                                <Card>
                                    <CardBody>
                                        ...
                                        <CardSubtitle
                                            className="mb-3">Add <code>.btn-lg</code> or <code>.btn-sm</code> for
                                            additional sizes.</CardSubtitle>
                            ...
                            <Col lg={6}>
                                <Card>
                                    <CardBody>
                                        ...
                                        <CardSubtitle
                                            className="mb-3">Add <code>.w-xs</code>, <code>.w-sm</code>, <code>.w-md</code> and <code> .w-lg</code> className
                                            for additional buttons width.</CardSubtitle>

                                        <div className="button-items">
                                            <button type="button"
                                                    className="btn btn-primary w-xs waves-effect waves-light">Xs
                                            </button>
                                            <button type="button"
                                                    className="btn btn-danger w-sm waves-effect waves-light">Small
                                            </button>
                                            <button type="button"
                                                    className="btn btn-warning w-md waves-effect waves-light">Medium
                                            </button>
                                            <button type="button"
                                                    className="btn btn-success w-lg waves-effect waves-light">Large
                                            </button>
                                        </div>
                                    </CardBody>
                                </Card>
                            ...
                            <Col lg={6}>
                                <Card>
                                    <CardBody>
                                        ...
                                        <CardTitle>Button tags</CardTitle>
                                        <CardSubtitle className="mb-3">The <code
                                            className="highlighter-rouge">.btn</code>
                            ...
                            <Col lg={6}>
                                <Card>
                                    <CardBody>
                                        ...
                                        <CardSubtitle className="mb-3">Add <code
                                            className="highlighter-rouge">data-toggle="button"</code>
                            ...
                            <Col lg={6}>
                                <Card>
                                    <CardBody>
                                        ...
                                        <CardSubtitle className="mb-3">Create block level buttons—those that span the
                                            full width of a parent—by adding <code
                                ...
                                <Card>
                                    <CardBody>
                                        ...
                                        <CardSubtitle className="mb-3">Bootstrap’s <code
                                            ...
                                            modified buttons to enable toggling in their respective
                                            styles.</CardSubtitle>
                                ...
                                <Card>
                                    <CardBody>
                                        ...
                                        <Row>
                                            ...
                                            <Col md={6}>
                                                <div className="btn-group mt-4 mt-md-0" role="group"
                                                     aria-label="Basic example">
                                                    <button type="button" className="btn btn-secondary"><i
                                                        className="bx bx-menu-alt-right"></i></button>
                                                    <button type="button" className="btn btn-secondary"><i
                                                        className="bx bx-menu"></i></button>
                                                    <button type="button" className="btn btn-secondary"><i
                                                        className="bx bx-menu-alt-left"></i></button>
                                                </div>
                                            </Col>
                                        </Row>
                            ...
                            <Col lg={6}>
                                <Card>
                                    <CardBody>
                                        ...
                                        <CardSubtitle className="mb-3">Make a set of buttons appear vertically stacked
                                            rather than horizontally. Split button dropdowns are not supported
                                            here.</CardSubtitle>
