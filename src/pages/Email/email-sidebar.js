        ...
        return (
            <React.Fragment>
                <Card className="email-leftbar">
                    <Button type="button" color="danger" className="waves-effect waves-light" onClick={this.togglemodal}
                            block>
                        Compose
                    </Button>
                    <div className="mail-list mt-4">
                        <Link to="email-inbox" className="active"><i
                            className="mdi mdi-email-outline mr-2"></i> Inbox <span
                            className="ml-1 float-right">(18)</span></Link>
                    ...
                    <div className="mail-list mt-1">
                        <Link to="#"><span className="mdi mdi-arrow-right-drop-circle text-info float-right"></span>Theme
                            Support</Link>
                ...
                <Modal isOpen={this.state.modal} role="dialog" autoFocus={true} centered={true} className="exampleModal"
                       tabIndex="-1" toggle={this.togglemodal}>
                    ...
                    <div className="modal-content">
                        ...
                        <ModalFooter>
                            ...
                            <Button type="button" color="primary">Send <i
                                className="fab fa-telegram-plane ml-1"></i></Button>
                        </ModalFooter>
                    </div>
                </Modal>
            </React.Fragment>
